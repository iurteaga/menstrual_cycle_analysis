...
This is a basic script that illustrates how to load cycle-length data to fit a generative Poisson cycle length model and then make predictions using such model (in the same set of users)
https://github.com/iurteaga/menstrual_cycle_analysis/blob/master/scripts/poisson_model_fit_predict.py
...
Summary of script
Data-loading
https://github.com/iurteaga/menstrual_cycle_analysis/blob/master/scripts/poisson_model_fit_predict.py#L38
Loads pickled ../data/cycle_length_data/cycle_lengths.npz dataset
And gets dataset details I,C, and X
Model instantiation and configuration, from input config file
https://github.com/iurteaga/menstrual_cycle_analysis/blob/master/scripts/poisson_model_fit_predict.py#L54
Instantiates model, as determined by information in ./generative_model_config/generative_poisson_with_skipped_cycles
https://github.com/iurteaga/menstrual_cycle_analysis/blob/master/scripts/poisson_model_fit_predict.py#L48
Loads model fitting, optimization, and prediction parameters from ./generative_model_config/generative_poisson_with_skipped_cycles
Fitting
https://github.com/iurteaga/menstrual_cycle_analysis/blob/master/scripts/poisson_model_fit_predict.py#L147
...
Prediction
https://github.com/iurteaga/menstrual_cycle_analysis/blob/master/scripts/poisson_model_fit_predict.py#L154
...
The output is my_model_predictions
a dictionary, with only ‘mean’ as a key, with a numpy array of size I by length of day_range:, i.e., my_model_predictions['mean'][i,d] is the model’s predicted cycle length for user i in day d
